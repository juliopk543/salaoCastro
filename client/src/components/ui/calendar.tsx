  ...
  return (
    <DayPicker
      ...
      className={cn(
        ...
        "w-full max-w-none flex flex-col",
        "[--cell-size:calc((100vw-3rem)/7)]",
        "**:data-[slot=months]:w-full **:data-[slot=months]:flex **:data-[slot=months]:flex-col",
        "**:data-[slot=month]:w-full **:data-[slot=month]:flex **:data-[slot=month]:flex-col",
        "**:data-[slot=table]:w-full **:data-[slot=table]:border-collapse **:data-[slot=table]:flex **:data-[slot=table]:flex-col",
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        "flex-1 items-stretch disabled:opacity-30 disabled:cursor-not-allowed",
        defaultClassNames.day,
        className
      )}
      {...props}
