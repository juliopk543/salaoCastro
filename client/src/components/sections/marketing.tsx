                ...
                >
                  ...
                  <CardFooter className="p-8 pt-0 mt-auto">
                    <Dialog>
                      ...
                      <DialogContent className="fixed inset-0 z-50 flex flex-col justify-end bg-black/40 sm:inset-auto sm:left-[50%] sm:top-[50%] sm:max-w-[500px] sm:translate-x-[-50%] sm:translate-y-[-50%] sm:rounded-lg sm:bg-transparent sm:shadow-none sm:p-0 [&>button]:hidden" aria-describedby="dialog-description">
                        <motion.div
                          ...
                          className="bg-white sm:rounded-t-[2.5rem] rounded-none p-6 md:p-10 shadow-[0_-16px_48px_-12px_rgba(0,0,0,0.2)] relative border-t border-primary/5 w-full h-[95vh] sm:h-auto overflow-y-auto custom-scrollbar"
                        >
