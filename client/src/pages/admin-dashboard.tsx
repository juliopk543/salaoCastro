      ...
      <main className="flex-1 p-8 md:p-12 lg:p-16 overflow-auto">
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <Card className="shadow-2xl shadow-slate-200/50 border-none bg-white rounded-[2.5rem] overflow-hidden">
            <CardHeader className="border-b border-slate-100 p-8 flex flex-row items-center justify-between bg-slate-50/30">
              <div>
                <CardTitle className="text-2xl font-black text-[#1a1f36] tracking-tight">Últimas Solicitações</CardTitle>
                <p className="text-sm text-[#4f566b] mt-1 font-medium">Lista detalhada dos últimos contatos recebidos.</p>
              </div>
            </CardHeader>
            <CardContent className="p-0">
              {isLoading ? (
                ...
                <div className="flex flex-col items-center justify-center py-32 px-10 text-center">
                  ...
                  <h3 className="text-2xl font-black text-[#1a1f36]">Nenhuma solicitação</h3>
                  <p className="text-[#4f566b] max-w-sm mt-2 font-medium">
